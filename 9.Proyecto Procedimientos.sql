...
-- 9.6 Tablas de soporte para stock
...
-- 9.18 Tabla de soporte para reseñas
...
BEGIN
    ...
    UPDATE ventas SET total = v_precio_actual * p_cantidad WHERE id_venta = v_id_venta;
...
-- 9.12 sp_ObtenerDetallesProductoCompleto: Devuelve toda la información de un producto, incluyendo datos de su proveedor y categoría.
...
-- ==============================================================================
-- LLAMADAS DE PRUEBA (Comentadas para no alterar los datos al ejecutar el script)
-- ==============================================================================
/*
