...
-- Eliminar vistas de seguridad si ya existen
...
-- 6.13 Crear una vista que oculte información sensible para el rol Atencion_Cliente.
...
GRANT SELECT ON proyectosql.log_cambios_precio TO 'Auditor_Financiero'; 
...
-- 6.13 Dar acceso a la vista creada al rol Atencion_Cliente.
...
ALTER USER 'Analista_Datos'@'%' WITH MAX_QUERIES_PER_HOUR 100;